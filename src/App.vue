...
let inputVal = ref(
  "http://cloudstorage.ihubin.com/blog/audio-video/blog-17/rainbow.gif"
);
let gif = ref({
...
<template>
  <div style="display: flex; flex-direction: column; align-items: center">
    <div style="display: flex; flex-direction: row; align-items: center">
      ...
      <div :style="{
        width: `${gif.logicScreen.canvasWidth}px`,
        height: `${gif.logicScreen.canvasHeight}px`,
        border: '1px solid black',
      }">
        <div :style="{ whiteSpace: 'pre-wrap' }">
          {{ JSON.stringify(gif.logicScreen, null, "\t") }}
        </div>
        <ColorTable :canvasWidth="gif.logicScreen.canvasWidth" :canvasHeight="gif.logicScreen.canvasHeight"
          :colorTable="gif.globalColor" />
        <div>
          <h2>Comment</h2>
    ...
    <div style="display: flex; Fflex-direction: row;align-items: center;width: 100%;flex-wrap: wrap;">
      ...
      <div v-for="(img, key) in gif.imgs">
        <Frame :index="key" :graphControl="gif.graphControls[key]" :colorStream="img.data"
          :canvasWidth="gif.logicScreen.canvasWidth" :canvasHeight="gif.logicScreen.canvasHeight"
          :imgScreen="img.imgScreen" :colorTable="gif.globalColor || gif.localColor" />
      </div>
    </div>
  </div>
</template>
